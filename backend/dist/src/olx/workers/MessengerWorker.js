...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield messengerPage.close();
        // await messenger.sendMessage(links[0])
        // parentPort?.postMessage('finish')
        node_worker_threads_1.parentPort === null || node_worker_threads_1.parentPort === void 0 ? void 0 : node_worker_threads_1.parentPort.postMessage({ type: 'status', content: 'finished' });
    });
}
main();
class Messenger {
